import { IPayTitleMap } from "./src/video-poker/types";
...
const rtpCalculator = new RTPCalculator(
  game.pay_calculator.pay_table,
  selector
);
rtpCalculator.emit.doneParallel =
  rtpCalculator.printDefaultStatistics.bind(rtpCalculator);
